...
const ActiveText: React.FC<ActiveTextProps> = ({ onClick, children, className, link, download }) => {
  const joinedClassName = `${className} justify-self-start focus:ring-2 ring-blue-600 dark:ring-blue-300 text-slate-950 dark:text-slate-50 hover:text-blue-600 dark:hover:text-blue-300 outline-none rounded-sm`;
